...
export const seedItems: SeedItem[] = [
  ...
  },
  {
    ...
    data: {
      ...
      techStackMobile: 'Python, TensorFlow, Scikit-learn, Streamlit',
      links: [
        {
          label: 'GitHub',
          url: 'https://github.com/spencerjireh/jirehs-breast-cancer-predictor',
        },
        {
          label: 'Live Demo',
          url: 'https://flymetothesun-jirehs-breast-cancer-predictor-appmain-wbz36v.streamlit.app/',
        },
      ],
      descriptions: [
        'A machine learning application designed to assist medical professionals in predicting breast cancer malignancy. The model analyzes cell nuclei characteristics from fine needle aspirate (FNA) images to classify tumors as benign or malignant.',
        'Built with an intuitive Streamlit interface that allows laboratory technicians to input measurements and receive instant predictions with confidence scores. The model achieves high accuracy through ensemble methods and careful feature engineering.',
      ],
      highlightsTitle: 'Key Features',
      highlights: [
        'Ensemble ML model with high prediction accuracy',
        'Interactive Streamlit UI for medical staff',
